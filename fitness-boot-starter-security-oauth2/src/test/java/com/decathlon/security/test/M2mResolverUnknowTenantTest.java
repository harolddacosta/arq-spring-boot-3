...
@TestPropertySource(
        properties = {
            ...
            "spring.security.oauth2.resourceserver.client-id=is_present",
            "spring.security.oauth2.resourceserver.m2m.client-id=problem"
        })
@Slf4j
class M2mResolverUnknowTenantTest {
    ...
    void test_second_token() {
        ...
        request.addHeader(
                "Authorization",
                "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJhdWQiOiJ2YWxpZC1hdWRpZW5jZSIsInV1aWQiOiJpdHMgZGlmZmVyZW50In0.QuHlMWSGrD41ppN5TQA8AqPs5HwOGXlueRjwg4FfTSU");
        ...
        assertThrowsExactly(
                ...
                () -> {
                    Authentication auth =
                            resolverSelected.authenticate(
                                    new BearerTokenAuthenticationToken(
                                            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJhdWQiOiJ2YWxpZC1hdWRpZW5jZSIsInV1aWQiOiJpdHMgZGlmZmVyZW50In0.QuHlMWSGrD41ppN5TQA8AqPs5HwOGXlueRjwg4FfTSU"));
                });
    }
}
