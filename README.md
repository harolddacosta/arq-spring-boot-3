...
**SpringWatch** is an evolution from **SpringWatch** (v2 and v3) inspired in a hexagonal architecture and spring starters architecture modules for creating microservices
